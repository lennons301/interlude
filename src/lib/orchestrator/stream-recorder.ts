...
/** Event types the Claude Code stream parser already understands, whether it
 ...
 * outside this set is unrecognised and gets written down verbatim. The
 * OpenCode parser (issue #222) applies its own understanding before
 * forwarding — see its module note — so this set stays one harness's.
 *
